...
with DAG(
    ...
    run_hello_world_in_k8s = KubernetesPodOperator(
        namespace='dev1',  # Specify the namespace for your Kubernetes cluster user
        image='cck03-ndc-ua08.ndc.singtel.net/ezua/rocky_java-mapr:latest',  # Open-source Alpine Linux image
        cmds=["sh", "-c"],
